    ...
    return (
        ...
        <div className="w-full mx-auto bg-gray-800 rounded-md p-9 text-center">
            {props.account_id == account?.account.id && <button
                className="ml-auto bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-sm px-2 py-1 rounded shadow hover:shadow-lg outline-none focus:outline-none mx-1 my-1 ease-linear transition-all duration-150"
